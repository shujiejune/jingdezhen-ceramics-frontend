...
// This is the component that will only be rendered on the client
...
const ExpandedMenu: Component<ExpandedMenuProps> = (props) => {
  const menuItems = [
    { to: "/ceramicstory", icon: CeramicstoryIcon, text: "Ceramic Story" },
    { to: "/gallery", icon: Trophy, text: "Gallery" },
    { to: "/engage", icon: EngageIcon, text: "Engage" },
